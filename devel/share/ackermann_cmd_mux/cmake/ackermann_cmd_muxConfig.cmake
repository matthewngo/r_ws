...
if("TRUE" STREQUAL "TRUE")
  set(ackermann_cmd_mux_SOURCE_PREFIX /home/mvn3/r_ws/src/racecar_base/ackermann_cmd_mux)
  set(ackermann_cmd_mux_DEVEL_PREFIX /home/mvn3/r_ws/devel)
  ...
  set(ackermann_cmd_mux_INSTALL_PREFIX /home/mvn3/r_ws/install)
...
if(NOT "/home/mvn3/r_ws/devel/include;/home/mvn3/r_ws/src/racecar_base/ackermann_cmd_mux/include " STREQUAL " ")
  set(ackermann_cmd_mux_INCLUDE_DIRS "")
  set(_include_dirs "/home/mvn3/r_ws/devel/include;/home/mvn3/r_ws/src/racecar_base/ackermann_cmd_mux/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ackermann_cmd_mux' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mvn3/r_ws/src/racecar_base/ackermann_cmd_mux/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mvn3/r_ws/devel/lib;/home/mvn3/r_ws/devel/lib;/opt/ros/kinetic/lib)
